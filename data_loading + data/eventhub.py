...
# load connection string from environment variable, never hardcode secrets
EH_NAMESPACE = "eh-ns-dbxproject-pari"
EH_NAME = "orders"
EH_CONN_STR = os.environ.get("EH_CONN_STR")  # set this as a databricks secret or environment variable
